...
exports.findMany = exports.findOneAndDelete = exports.findOneAndUpdate = exports.findOne = void 0;
...
function findOneAndUpdate(filter, document, options) {
    var args = {
        ...
        options: {
            ...
            returnNewDocument: options === null || options === void 0 ? void 0 : options.returnNewDocument,
        },
        filter: filter,
        document: document,
    };
